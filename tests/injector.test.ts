...
describe('injector', () => {
  it('generates CLAUDE.md with project metadata, governance rules, and agent instructions', () => {
    ...
    expect(result.claudeMd).toContain('Await user approval')
    expect(result.claudeMd).toContain('claude, cursor')
    expect(result.claudeMd).toContain('src, tests')
    expect(result.claudeMd).toContain('src/auth, .env')
  ...
  it('generates .cursorrules with authorized scope and core rules', () => {
    ...
    expect(result.cursorrules).toContain('modifying >3 files')
    expect(result.cursorrules).toContain('Stay in: src, tests')
    expect(result.cursorrules).toContain('Protected: src/auth, .env')
  })
  ...
  it('generates .windsurfrules identical to .cursorrules content', () => {
    ...
    expect(result.windsurfrules).toContain('Stay in: src, tests')
  })
